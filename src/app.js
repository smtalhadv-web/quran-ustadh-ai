...
function fullReaderMarkup(){
  ...
  if(fullReader.error || !fullReader.data){
    return `<div class="quran-shell"><div class="mushaf-header">Open-source Quran data unavailable</div><div class="center" style="padding:80px 16px"><p class="small">Please reconnect to the internet and try again. No closed or permission-gated fallback is used.</p></div></div>`;
  }
